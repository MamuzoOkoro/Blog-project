    ...
    <div className="w-full h-[100vh] bg-[white] flex justify-center items-center ">
      ...
      <div className="w-[85%] h-[100vh]  rounded-md flex flex-col">
        ...
        <div className="w-full h-[30%] bg-[#ddf5f1] rounded-br-[10px] rounded-bl-[10px] flex items-center justify-center flex-col">
          ...
          <button className="h-[40px] min-w-[150px] rounded-md flex items-center justify-center border border-[#FF6719] font-[500] text-[16px] text-[#FF6719] font-astro">
            As An Admin
          </button>
          </NavLink>
          <NavLink to="/userSignIn">
          <button className="h-[40px] min-w-[150px] bg-[#FF6719] rounded-md flex items-center justify-center ml-[5px] font-astro text-[white] font-[500] text-[16px]">
            User
          </button>
          </NavLink>
          </div>
